...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    /******/([
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            Isomer.prototype.setGlobalTransform = function (x, y) {
                globalTransformX = x
                globalTransformY = y
            }
             ...
             */
            Isomer.prototype.add = function (item, baseColor, itemId) {
                if (Object.prototype.toString.call(item) == '[object Array]') {
                    ...
                    // isomerAnimation.objects[itemId] = {
                    //     start: Date.now()
                    // }
                    let item2 = item.translate(-globalTransformX + offsetX, -globalTransformY + offsetY, 0)
                    /* Fetch paths ordered by distance to prevent overlaps */
                    var paths = item2.orderedPaths();
